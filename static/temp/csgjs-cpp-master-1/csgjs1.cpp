...
EMSCRIPTEN_BINDINGS(CsgjsVector)
{
    class_<csgjs_vector>("CsgjsVector")
        .constructor<>()              // 构造函数
        .constructor<int, int, int>() // 构造函数
...
{
    csgjs_vector pos;
    csgjs_vector getPos() const
    {
        return this->pos;
    };
    void setPos(csgjs_vector _pos)
    {
        this->pos = _pos;
    };
    csgjs_vector normal;
...
EMSCRIPTEN_BINDINGS(CsgjsVertex)
{
    class_<csgjs_vertex>("CsgjsVertex")
        .constructor<>()
        .property("pos", &csgjs_vertex::getPos, &csgjs_vertex::setPos)
...
EMSCRIPTEN_BINDINGS(CsgjsModel)
{
...
EMSCRIPTEN_BINDINGS(CsgjsPlane)
{
...
EMSCRIPTEN_BINDINGS(CsgjsPolygon)
{
...
EMSCRIPTEN_BINDINGS(CsgjsCsgnode)
{
    class_<csgjs_node>("CsgjsCsgnode")
        .property("polygons", &csgjs_node::getPolygons, &csgjs_node::setPolygons)
        .property("front", &csgjs_node::getFront, &csgjs_node::setFront)
        .property("back", &csgjs_node::getBack, &csgjs_node::setBack)
        .property("plane", &csgjs_node::getPlane, &csgjs_node::setPlane)

        .constructor<>()
        .constructor<const std::vector<csgjs_polygon> &>()

        .function("clipTO", &csgjs_node::clipTo)
        ...
        .function("clone", &csgjs_node::clone);
}
...
EMSCRIPTEN_BINDINGS(Other)
{
    function("flip", &flip);
    function("interpolate", &interpolate);
    function("csg_union", &csg_union);
    function("csg_subtract", &csg_subtract);
    function("csg_intersect", &csg_intersect);

    function("csgjs_modelToPolygons", &csgjs_modelToPolygons);
    function("csgjs_operation", &csgjs_operation);
    function("csgjs_union", &csgjs_union);

    function("csgjs_intersection", &csgjs_intersection);
    function("csgjs_difference", &csgjs_difference);
}
